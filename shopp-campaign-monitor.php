<?php
/*
Plugin Name: Shopp + Campaign Monitor
Description: Customers who opt-in to email marketing from your WordPress ecommerce site during checkout are added to a specified list on Campaign Monitor.
Version: 1.3
...
require_once('inc/csrest-subscribers.php');

Shopp_CampaignMonitor::smartLoad();

class Shopp_CampaignMonitor {
	public static $list_id;
	public static $api_key;
	
	public static function smartLoad() {
		$instantiate = apply_filters('shoppCampaignMonitorLoadBasic', true);
		if ($instantiate) { new Shopp_CampaignMonitor; }
	}

	public function __construct() {
		add_action('admin_init', array($this, 'admin_css'));
		add_action('admin_menu', array($this, 'admin_menu'));
		add_action('shopp_order_success', array($this, 'add_to_campaign_monitor_list'));
		
		$this->list_id = get_option('shopp_campaign_monitor_list_id');		
		$this->api_key = get_option('shopp_campaign_monitor_api_key');

	}

	public function admin_css() {
		wp_register_style( 'shopp-campaign-monitor-stylesheet', plugins_url( 'css/shopp-campaign-monitor.css', __FILE__ ), array(), '20140823' );
		wp_enqueue_style( 'shopp-campaign-monitor-stylesheet' );
	}
	...
	public function admin_menu() {
		...
		$page = add_submenu_page('shopp-101-extensions', 'Campaign Monitor', 'Campaign Monitor', 'shopp_menu', 'shopp-campaign-monitor', array($this, 'render_display_settings'));
        add_action( 'admin_print_styles-' . $page, 'admin_styles' );
		...
		<div class="metabox-holder">	
			...
			<div id="shopp-extensions-about-the-author" class="postbox">
				...
				<div class="inside">
					<table border="0" width="100%">
   					 	<tr>
                            <td width="70%"><div><img style="padding: 0px 15px 0px 0px; float:left" src="<?php echo plugins_url( 'shopp-campaign-monitor/images/lorenzo-orlando-caum-shopp-wordpress-150x150.jpg' , dirname(__FILE__) ); ?>" border="0" alt="Founder of Enzo12 LLC" width="150" height="150">
...
<?php	 	 
	...
	public function add_to_campaign_monitor_list($Purchase) {
		global $wpdb;
		
		$marketing = $wpdb->get_var("SELECT marketing FROM ".$wpdb->prefix."shopp_customer WHERE id = '".$Purchase->customer."'");
		
		if($marketing == "yes"){
			$campaign_monitor_api = new CS_REST_Subscribers(get_option("shopp_campaign_monitor_list_id", $this->list_id), get_option("shopp_campaign_monitor_api_key", $this->api_key), 'https');

			$firstname = $Purchase->firstname;
			$lastname = $Purchase->lastname;
			$fullname = $firstname.' '.$lastname;

			$campaign_monitor_user = $campaign_monitor_api->add(array(
	...
	public function render_display_settings() {
		wp_nonce_field('shopp-campaign-monitor');	
		if(!empty($_POST['submit'])){			

			$this->list_id = stripslashes($_POST['list_id']);
			$this->api_key = stripslashes($_POST['api_key']);
			
			update_option("shopp_campaign_monitor_list_id", $this->list_id);
			update_option("shopp_campaign_monitor_api_key", $this->api_key);
		}
?>

<div class="wrap">
	<h2>Shopp + Campaign Monitor</h2>
	<div class="postbox-container" style="width:65%;">
		<div class="metabox-holder">	

			<div id="shopp-campaign-monitor-introduction" class="postbox">
				<h3 class="hndle"><span>Introduction</span></h3>
				<div class="inside">
					<p>This plugin integrates <a href="http://shopp101.com/go/shopp/" title="Learn more about Shopp">Shopp</a> with <a href="http://shopp101.com/go/campaignmonitor/" title="Learn more about Campaign Monitor">Campaign Monitor</a> and is part of the Shopp 101 extensions.</p> 
					<p>During checkout, a customer has the option to opt-in to email marketing. If they choose to do so, then they will be added to a specified email list on Campaign Monitor.</p>
					...
					<p>Credit to Campaign Monitor who created the PHP API Wrapper for the Campaign Monitor API. <a href="https://github.com/campaignmonitor/createsend-php" title="Learn about the PHP API Wrapper for Campaign Monitor">Learn more about the Campaign Monitor API</a></p>
				</div>
			</div>

			<div id="shopp-campaign-monitor-general-settings" class="postbox">
				<h3 class="hndle"><span>Setup Tutorial</span></h3>
				<div class="inside">
				<p><strong>How to Find Your Information from Campaign Monitor</strong><br /><br /><iframe src="http://player.vimeo.com/video/32680409?title=0&amp;byline=0&amp;portrait=0" width="600" height="300" frameborder="0" webkitAllowFullScreen allowFullScreen></iframe></p>
                <p>Pro-tip: After starting a video, click on the fullscreen button which appears to the right of the HD toggle.</p>
				</div>
			</div>
			
			<div id="shopp-campaign-monitor-support-feedback" class="postbox">
				<h3 class="hndle"><span>Support & Feedback</span></h3>
				<div class="inside">
                ...
                <p>You can share feedback via this a <a href="http://shopp101.com/go/shopp-extensions-survey/" title="Take a super short survey">short survey</a>. Takes just a few minutes &mdash; we promise!</p>
                <p>Feeling generous? You can support the continued development of the Shopp + Campaign Monitor by <a href="http://shopp101.com/go/donate-shopp-campaign-monitor/" title="Say thank you by purchasing Lorenzo a Redbull">buying me a Redbull</a>, <a href="http://shopp101.com/go/amazonwishlist/" title="Say thank you by gifting Lorenzo a book">ordering me a book</a> from my Amazon wishlist, or <a href="http://shopp101.com/go/tip-shopp-help-desk/" title="Say thank you by tipping Lorenzo via the Shopp Help Desk">tipping me</a> through the Shopp help desk.</p>
				</div>
			</div>
			
			<div id="shopp-campaign-monitor-settings" class="postbox">
				<h3 class="hndle"><span>Campaign Monitor Settings</span></h3>
				<div class="inside">
                    <p>
					<form action="" method="post">
					<table>
					<tr>
						<th>API Subscriber List ID:</th>
			...
			<div id="shopp-campaign-monitor-about-the-author" class="postbox">
				<h3 class="hndle"><span>About the Author</span></h3>
				<div class="inside">
					<table border="0" width="100%">
   					 	<tr>
	...
	<div class="postbox-container" style="width:25%;">
		<div class="metabox-holder">	
			...
			<div id="shopp-campaign-monitor-donate" class="postbox">
				<h3 class="hndle"><span><strong>Make a Donation!</strong></span></h3>
				<div class="inside">
					<p>Hi friend!</p>
					<p>If this plugin is helpful to you, then please <a href="http://shopp101.com/go/donate-shopp-campaign-monitor/" title="Say thank you by purchasing Lorenzo a Redbull">buy me a Redbull</a>.</p>
					...
					<p>Your kindness is appreciated and will go towards <em>continued development</em> of the Shopp + Campaign Monitor plugin.</p>
				</div>
			</div>
			
			<div id="shopp-campaign-monitor-subscribe" class="postbox">
			...
			<div id="shopp-campaign-monitor-have-a-question" class="postbox">
				<h3 class="hndle"><span>Have a Question?</span></h3>
				<div class="inside">
                <p>Open a <a href="http://shopp101.com/help/" title="Open a new support ticket with Shopp 101">new support ticket</a> for Shopp + Campaign Monitor</p>
            ...
            <div id="shopp-campaign-monitor-news-from-oms" class="postbox">
				<h3 class="hndle"><span>News from Shopp 101</span></h3>
				<div class="inside">
				<p>Free Report<br /> <a href="http://shopp101.com/newsletter/" title="Receive your free report delivered instantly to your inbox">10 Steps to a More Secure WordPress</a></p>
				<p>Documents & Presentations<br /> <a href="http://shopp101.com/resources/white-papers/" title="Get your free white paper on creating a fast Shopp website">Speeding up your Shopp Ecommerce Website</a><br /><a href="http://shopp101.com/resources/white-papers/" title="Get your free white paper on using Shopp with caching plugins">Shopp + Caching Plugins</a></p>
			...
			<div id="shopp-campaign-monitor-recommendations" class="postbox">
